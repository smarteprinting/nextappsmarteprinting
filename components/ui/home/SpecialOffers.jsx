...
const specialOffers = [
    {
        id: 1,
        name: 'Wireless Multifunction Printer for Home Offices',
        price: 279,
        oldPrice: 388,
        sold: 52,
        stock: 'In Stock',
        image: OfferImage,
        badge: 'Best Seller',
        link: '/product-category/all-in-one-printers',
    },
    {
        id: 2,
        name: 'High-Speed Color Laser Printer for Busy Teams',
        price: 359,
        oldPrice: 399,
        sold: 34,
        stock: 'In Stock',
    ...
    {
        id: 3,
        name: 'Compact All-in-One Printer for Small Spaces',
        price: 539,
        oldPrice: 659,
        sold: 21,
        stock: 'In Stock',
