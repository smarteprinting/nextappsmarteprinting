...
export const metadata: Metadata = {
  ...
  description: 'Shop the best all-in-one printers for home and office at Smart ePrinting. Print, scan, copy, and fax with top brands like HP, Canon, and Brother.',
